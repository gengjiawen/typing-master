  ...
  for (i = 0; i < newChildrenLength; i++) {
    ...
    if (newDom != null) {
      ...
      if (
        ...
        (matchingIndex !== skewedIndex || oldVNode._children === childVNode._children)
      ) {
...
class Counter extends Component {
  ...
  render() {
    return createVNode('div', {
      children: [
        createVNode('h1', { children: ['Class Component Count: ', this.state.count] }),
...
render(
  createVNode('div', { children: [createVNode(Counter, {}), createVNode(CounterFunction, {})] }),
  document.body,
)
